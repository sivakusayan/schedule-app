...
"use strict";
eval("\n\nvar _Event = __webpack_require__(/*! ./models/Event */ \"./src/js/models/Event.js\");\n\nvar _Event2 = _interopRequireDefault(_Event);\n\nvar _EventDatabase = __webpack_require__(/*! ./models/EventDatabase */ \"./src/js/models/EventDatabase.js\");\n\nvar _EventDatabase2 = _interopRequireDefault(_EventDatabase);\n\nvar _TimeSlot = __webpack_require__(/*! ./models/TimeSlot */ \"./src/js/models/TimeSlot.js\");\n\nvar _TimeSlot2 = _interopRequireDefault(_TimeSlot);\n\nvar _TimeSlotDatabase = __webpack_require__(/*! ./models/TimeSlotDatabase */ \"./src/js/models/TimeSlotDatabase.js\");\n\nvar _TimeSlotDatabase2 = _interopRequireDefault(_TimeSlotDatabase);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar state = {\n  activeDay: 'MON',\n  selectedEvent: null,\n  eventDatabase: new _EventDatabase2.default(),\n  TimeSlotDatabase: new _TimeSlotDatabase2.default()\n};\n\nstate.eventDatabase.addToDatabase({\n  name: 'heyhey',\n  timeSlot: {\n    startTime: '09:00'\n  }\n}, 'TUE');\n\nstate.eventDatabase.addToDatabase({\n  name: 'heyhey10',\n  timeSlot: {\n    startTime: '10:00'\n  }\n}, 'TUE');\n\nstate.eventDatabase.addToDatabase({\n  name: 'heyhey8',\n  timeSlot: {\n    startTime: '08:00'\n  }\n}, 'TUE');\n\nconsole.log(state.eventDatabase);\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _TimeSlot = __webpack_require__(/*! ./TimeSlot */ \"./src/js/models/TimeSlot.js\");\n\nvar _TimeSlot2 = _interopRequireDefault(_TimeSlot);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Event = function Event(name, startTime, endTime, notes) {\n  _classCallCheck(this, Event);\n\n  this.name = name;\n  this.timeSlot = new _TimeSlot2.default(startTime, endTime);\n  this.notes = notes;\n};\n\nexports.default = Event;\n\n//# sourceURL=webpack:///./src/js/models/Event.js?");

/***/ }),

/***/ "./src/js/models/EventDatabase.js":
/*!****************************************!*\
  !*** ./src/js/models/EventDatabase.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Database2 = __webpack_require__(/*! ./Database */ \"./src/js/models/Database.js\");\n\nvar _Database3 = _interopRequireDefault(_Database2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar EventDatabase = function (_Database) {\n  _inherits(EventDatabase, _Database);\n\n  function EventDatabase() {\n    _classCallCheck(this, EventDatabase);\n\n    return _possibleConstructorReturn(this, (EventDatabase.__proto__ || Object.getPrototypeOf(EventDatabase)).apply(this, arguments));\n  }\n\n  _createClass(EventDatabase, [{\n    key: 'addToDatabase',\n    value: function addToDatabase(event, activeDay) {\n      if (this[activeDay].length === 0) {\n        // If no events, just push\n        this[activeDay].push(event);\n      } else {\n        // If there are events, linear search to keep database in order\n        var indexToInsert = 0;\n        this[activeDay].forEach(function (cur) {\n          if (event.timeSlot.startTime > cur.timeSlot.startTime) {\n            indexToInsert += 1;\n          }\n        });\n        this[activeDay].splice(indexToInsert, 0, event);\n      }\n    }\n  }]);\n\n  return EventDatabase;\n}(_Database3.default);\n\nexports.default = EventDatabase;\n\n//# sourceURL=webpack:///./src/js/models/EventDatabase.js?");

/***/ }),

/***/ "./src/js/models/TimeSlot.js":
/*!***********************************!*\
  !*** ./src/js/models/TimeSlot.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"]) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError(\"Invalid attempt to destructure non-iterable instance\"); } }; }();\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Database2 = __webpack_require__(/*! ./Database */ \"./src/js/models/Database.js\");\n\nvar _Database3 = _interopRequireDefault(_Database2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar TimeSlotDatabase = function (_Database) {\n  _inherits(TimeSlotDatabase, _Database);\n\n  function TimeSlotDatabase() {\n    _classCallCheck(this, TimeSlotDatabase);\n\n    return _possibleConstructorReturn(this, (TimeSlotDatabase.__proto__ || Object.getPrototypeOf(TimeSlotDatabase)).apply(this, arguments));\n  }\n\n  _createClass(TimeSlotDatabase, [{\n    key: 'addToDatabase',\n    value: function addToDatabase(timeSlot, activeDay) {\n      if (this[activeDay].length === 0) {\n        // If no timeSlots, just push\n        this[activeDay].push(timeSlot);\n      } else {\n        // If there are timeSlots, linear search to keep database in order\n        var indexToInsert = 0;\n        this[activeDay].forEach(function (cur) {\n          if (timeSlot.startTime > cur.startTime) {\n            indexToInsert += 1;\n          }\n        });\n        this[activeDay].splice(indexToInsert, 0, timeSlot);\n      }\n    }\n  }, {\n    key: 'validateNoTimeOverlap',\n    value: function validateNoTimeOverlap(timeSlot, activeDay) {\n      // Checks if timeSlot is overlaps an existing timeSlot\n      var _iteratorNormalCompletion = true;\n      var _didIteratorError = false;\n      var _iteratorError = undefined;\n\n      try {\n        for (var _iterator = this[activeDay][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n          var _ref = _step.value;\n\n          var _ref2 = _slicedToArray(_ref, 2);\n\n          var startTime = _ref2[0];\n          var endTime = _ref2[1];\n\n          // Check if startTime is valid\n          if (startTime <= timeSlot.startTime && timeSlot.startTime < endTime) {\n            return false;\n          }\n        }\n      } catch (err) {\n        _didIteratorError = true;\n        _iteratorError = err;\n      } finally {\n        try {\n          if (!_iteratorNormalCompletion && _iterator.return) {\n            _iterator.return();\n          }\n        } finally {\n          if (_didIteratorError) {\n            throw _iteratorError;\n          }\n        }\n      }\n\n      var _iteratorNormalCompletion2 = true;\n      var _didIteratorError2 = false;\n      var _iteratorError2 = undefined;\n\n      try {\n        for (var _iterator2 = this[activeDay][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n          var _ref3 = _step2.value;\n\n          var _ref4 = _slicedToArray(_ref3, 2);\n\n          var _startTime = _ref4[0];\n          var _endTime = _ref4[1];\n\n          // Check if endTime is valid\n          if (_startTime < timeSlot.endTime && timeSlot.endTime <= _endTime) {\n            return false;\n          }\n        }\n      } catch (err) {\n        _didIteratorError2 = true;\n        _iteratorError2 = err;\n      } finally {\n        try {\n          if (!_iteratorNormalCompletion2 && _iterator2.return) {\n            _iterator2.return();\n          }\n        } finally {\n          if (_didIteratorError2) {\n            throw _iteratorError2;\n          }\n        }\n      }\n\n      return true;\n    }\n  }, {\n    key: 'validateNoSubEvents',\n    value: function validateNoSubEvents(timeSlot, activeDay) {\n      // Checks if timeSlot swallows an existing timeSlot\n      var _iteratorNormalCompletion3 = true;\n      var _didIteratorError3 = false;\n      var _iteratorError3 = undefined;\n\n      try {\n        for (var _iterator3 = this[activeDay][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {\n          var _ref5 = _step3.value;\n\n          var _ref6 = _slicedToArray(_ref5, 2);\n\n          var startTime = _ref6[0];\n          var endTime = _ref6[1];\n\n          if (timeSlot.startTime <= startTime && endTime <= timeSlot.endTime) {\n            return false;\n          }\n        }\n      } catch (err) {\n        _didIteratorError3 = true;\n        _iteratorError3 = err;\n      } finally {\n        try {\n          if (!_iteratorNormalCompletion3 && _iterator3.return) {\n            _iterator3.return();\n          }\n        } finally {\n          if (_didIteratorError3) {\n            throw _iteratorError3;\n          }\n        }\n      }\n\n      return true;\n    }\n  }]);\n\n  return TimeSlotDatabase;\n}(_Database3.default);\n\nexports.default = TimeSlotDatabase;\n\n//# sourceURL=webpack:///./src/js/models/TimeSlotDatabase.js?");
